 ...
 *
 * @Block(
 *   id = "openagenda_active_filters_block",
 *   admin_label = @Translation("OpenAgenda - Active filters"),
 ...
 * )
 */
class OpenagendaActiveFiltersBlock extends BlockBase implements ContainerFactoryPluginInterface {
